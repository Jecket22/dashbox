...
$userdata = $db->prepare("UPDATE userdata SET stars = :stars, diamonds = :diamonds, starCoins = :starCoins, demons = :demons, orbs = :orbs, IP = :IP, mainIcon = :mainIcon, player = :player, ship = :ship, ball = :ball, ufo = :ufo, wave = :wave, robot = :robot, spider = :spider, glow = :glow, explosion = :explosion, trail = :trail, color1 = :color1, color2 = :color2, lastLogOn = :lastLogOn WHERE id = :userID");
$userdata->execute([':stars' => $_POST['stars'], ':diamonds' => $_POST['diamonds'], ':starCoins' => $_POST['coins'], ':demons' => $_POST['demons'], ':orbs' => $_POST['orbs'], ':IP' => Utils::getIP(), ':mainIcon' => $_POST['iconType'], ':player' => $_POST['accIcon'], ':ship' => $_POST['accShip'], ':ball' => $_POST['accBall'], ':ufo' => $_POST['accBird'], ':wave' => $_POST['accDart'], ':robot' => $_POST['accRobot'], ':spider' => $_POST['accSpider'], ':glow' => $_POST['accGlow'], ':explosion' => $_POST['accExplosion'], ':trail' => $_POST['special'], ':color1' => $_POST['color1'], ':color2' => $_POST['color2'], ':lastLogOn' => time(), ':userID' => $userID]);
